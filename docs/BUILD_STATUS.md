...
| Staging / DigitalOcean | New GymMembership project/server authorized; VPC/cloud firewall deferred. Target: blr1, 2 vCPU/4 GB, USD 24/month compute cap. Setup run 36121575880 confirmed DO_PROVISION_TOKEN was empty and skipped resource creation. No real resources, HTTPS or automatic-update proof yet. See DIGITALOCEAN_DEPLOYMENT.md. |
