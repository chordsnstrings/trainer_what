...
| Staging / DigitalOcean | New GymMembership project and server authorized; dedicated VPC/cloud firewall deferred. Setup workflow and checked-main host updater passed 36 local unit tests. Initial target: blr1, 2 vCPU/4 GB, USD 24/month compute cap. DO_PROVISION_TOKEN Actions secret is not configured. No real resources, new deployment CI, HTTPS or automatic-update proof yet. See DIGITALOCEAN_DEPLOYMENT.md. |
