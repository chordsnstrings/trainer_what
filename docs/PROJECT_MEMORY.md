...
- New migration: 010_nutrition. Local TypeScript, 51 PGlite tests and production web build have passed during development. Added browser journeys/screenshots for coach cases, nutrition onboarding, subscriber meals/groceries/pantry and offline diary reload/replay; CI PostgreSQL/container/browser evidence is pending in this checkpoint.
