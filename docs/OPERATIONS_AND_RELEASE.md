...
| DigitalOcean | Project/API scope, approved region and spend cap, managed-service availability, restore capability | Container/IaC definitions and synthetic local tests; sensitive production placement blocked |
