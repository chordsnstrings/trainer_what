...
**Nutrition scope update (25 September 2026):** [integration plan](docs/NUTRITION_INTEGRATION_PLAN.md), internal work IDs 035–044. Confirmed direction: workout-only and higher-priced workout + nutrition tiers; case-based coach onboarding teaches diet/calorie decisions; routine in-scope outputs are automatic, with human handling of exceptions. Nutrition connects daily meals, recipes, portions and cooking options to weekly groceries. The owner also locked meal-photo logging and food-barcode scanning into required combined-tier scope on 25 September at 12:27 Asia/Dubai; implement 043 and extend 044 acceptance. These capture features are not implemented or verified by the existing core checks. Core implementation has passed CI on both database engines, production build/container checks and 32 browser routes; consult [nutrition verification](docs/VERIFICATION_2026-09-25_NUTRITION.md) and docs/BUILD_STATUS.md for exact evidence and remaining live-service gates.
