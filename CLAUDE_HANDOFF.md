...
| Campaigns / affiliates | Consented attribution, safe copy experiments and deterministic lifecycle messages | Real affiliate contract/earnings settlement needs approved provider/business rules. Configurable cancellation alerts and upload/compilation review notices are implemented; predictive churn/rate claims and new mobile push transport are not supplied |
